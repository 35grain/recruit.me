...
export const Task = () => {
  return (
    ...
    >
      ...
      <Text>
        You can't do it all. We respect your time, and expect that you will have
        to make choices and tradeoffs for what is in scope for your deliverable.
      </Text>
      <Text>
        Don't worry about authentication. Assume a non-authenticated experience
